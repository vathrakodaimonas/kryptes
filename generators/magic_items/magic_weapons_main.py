...
class MagicWeaponGenerator:
    def __init__(self):
        ...
        self.magic_weapons_type_list = ['Ακόντιο', 'Σφύρα', 'Απελατίκι', 'Ράβδος', 'Σαλίβα', 'Ρομφαία', 'Λογχοπέλεκυς',
                                        'Ξίφος',
                                        'Βέλη', 'Σφαιρίδια', 'Σπάθη', f'Σφενδόνη με {random.randint(3, 18)} μύδρους', 'Δορυδρέπανο',
                                        f'Τζάγγρα με {random.randint(3, 18)} μύδρους',
                                        'Εγχειρίδιο',
                                        f'Τόξο με {random.randint(3, 18)} βέλη',
                                        'Δόρυ', f'Τόξο, σύνθετο με {random.randint(3, 18)} βέλη', 'Μύδροι', 'Τσεκούρι', 'Μάχαιρα', 'Φαλξ', 'Πέλεκυς']
